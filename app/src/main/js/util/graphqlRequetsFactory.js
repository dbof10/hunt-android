const JOB_QUERY = 'query JobsPage($cursor: String, $query: String, $locations: [String!], $skills: [String!], $roles: [String!], $remote_ok: Boolean, $upvoted: Boolean, $product_ids: [String!], $promoted: Boolean) ' +
