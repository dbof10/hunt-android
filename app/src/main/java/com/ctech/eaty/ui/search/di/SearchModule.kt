...
class SearchModule {
    ...
    fun provideSearchStore(searchRepository: SearchRepository,
        ...
        return Store<SearchState>(SearchState(), SearchReducer(), arrayOf(LoadEpic(searchRepository, threadScheduler),
    ...
    fun provideSearchViewModel(store: Store<SearchState>,
        ...
        return SearchViewModel(store.state, threadScheduler, navigation)
    }
}