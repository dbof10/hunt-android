...
class CommentCollapsedViewHolder(view: View, val imageLoader: GlideImageLoader) : AbsViewHolder(view), ViewMoreTextView.OnViewMoreClickListener {
    ...
    companion object {
        fun create(parent: ViewGroup, imageLoader: GlideImageLoader): AbsViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_comment_collapsed, parent, false)
            return CommentCollapsedViewHolder(view, imageLoader)
        }
    }
