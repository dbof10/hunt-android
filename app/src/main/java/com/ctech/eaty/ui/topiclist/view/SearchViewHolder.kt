...
class SearchViewHolder(view: View, val imageLoader: GlideImageLoader) : AbsViewHolder(view) {
    ...
    companion object {
        fun create(parent: ViewGroup, imageLoader: GlideImageLoader, square: Boolean = false): AbsViewHolder {
            @LayoutRes val layoutRes = if (square) R.layout.item_search_square else R.layout.item_search
